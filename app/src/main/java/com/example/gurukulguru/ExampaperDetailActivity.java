...
public class ExampaperDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exampaper_detail);
        subjects_recycler=findViewById(R.id.subjectinExampaper);
        subjects=new ArrayList<>();
        subjectsArrayList=new ArrayList<>();

        class_no=MyStaticClass.classname;
        nmaeofclass=findViewById(R.id.classname_Exampaper);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReferencedetails_subjects.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        detail_subject_adapter subject_adapter=new detail_subject_adapter(ExampaperDetailActivity.this,subjectsArrayList,"Exampaper");
                        subjects_recycler.setAdapter(subject_adapter);
                        subjects_recycler.setLayoutManager(new LinearLayoutManager(ExampaperDetailActivity.this));
                    }

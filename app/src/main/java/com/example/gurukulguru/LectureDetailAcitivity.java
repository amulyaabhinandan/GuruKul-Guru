...
public class LectureDetailAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lecture_detail_acitivity);

        subjects_recycler=findViewById(R.id.subjects_recyclerview_lecture);
        subjects=new ArrayList<>();
        subjectsArrayList=new ArrayList<>();

        class_no=MyStaticClass.classname;
        nmaeofclass=findViewById(R.id.class_number_lecture);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReferencedetails_subjects.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        detail_subject_adapter subject_adapter=new detail_subject_adapter(LectureDetailAcitivity.this,subjectsArrayList,"Lectures");
                        subjects_recycler.setAdapter(subject_adapter);
                        subjects_recycler.setLayoutManager(new LinearLayoutManager(LectureDetailAcitivity.this));

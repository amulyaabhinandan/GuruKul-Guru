...
public class Homework_Card extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homework__card);

        myclass=findViewById(R.id.myclass_holder_homework);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Classes_Adapter classes_adapter=new Classes_Adapter(Homework_Card.this,mylist,"Homework");
                myclass.setAdapter(classes_adapter);
                myclass.setLayoutManager(new LinearLayoutManager(Homework_Card.this));
            }

...
import com.example.gurukulguru.DetailsClassActivity;
...
import com.example.gurukulguru.detail_student_adapter;
...
public class Exampaper_Sub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exampaper__sub);
        add=findViewById(R.id.add_exampaper);
        subname=findViewById(R.id.exampapersubject);
        subname.setText(MyStaticClass.subjectname);
        myrecycle=findViewById(R.id.add_exampaper_recycler);
        documents=new ArrayList<>();

        docs2=new ArrayList<>();

        databaseReference= FirebaseDatabase.getInstance().getReference().child("EXAMPAPER").child(MyStaticClass.classname).child(MyStaticClass.subjectname);
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.getChildrenCount() == 0) {
                    ...
                    Document_Adapter student_adapter = new Document_Adapter(Exampaper_Sub.this,"EXAMPAPER", docs2);
                    myrecycle.setAdapter(student_adapter);
                    myrecycle.setLayoutManager(new LinearLayoutManager(Exampaper_Sub.this));
                }
            }
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Exampaper_Sub.this, AddDocumentActivity.class));
            }
        });
    }
}

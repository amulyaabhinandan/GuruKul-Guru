...
public class Notes_Sub_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notes__sub_);
        add=findViewById(R.id.add_notes);
        subname=findViewById(R.id.notesubjects);
        subname.setText(MyStaticClass.subjectname);
        myrecycle=findViewById(R.id.add_notes_recycler);
        documents=new ArrayList<>();
        docs2=new ArrayList<>();

        databaseReference= FirebaseDatabase.getInstance().getReference().child("NOTES").child(MyStaticClass.classname).child(MyStaticClass.subjectname);
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.getChildrenCount() == 0) {
                    ...
                    Document_Adapter student_adapter = new Document_Adapter(Notes_Sub_Activity.this,"NOTES", docs2);
                    myrecycle.setAdapter(student_adapter);
                    myrecycle.setLayoutManager(new LinearLayoutManager(Notes_Sub_Activity.this));
                }
            }
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Notes_Sub_Activity.this, AddDocumentActivity.class));
